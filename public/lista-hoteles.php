<?php
    ...
    $contador = $type->CountGetHotelesPaises($CountryCode);

    $total = $contador['contador'][0];

    $hoteles = $type->GetHotelesPaises($CountryCode,$limit,$offset);
    $choteles = $fn->cuenta($hoteles);
...
<head>
    ...
    <title>Conoce <?php echo ucfirst(strtolower($hoteles['description'][0])) ?> | Lex Go Travel</title>
...
<body>
    ...
    <!--BODY-->
        <div class="" id="portada-nosotros" style="height: 335px; background-image: url(medios/img/lista-hoteles.jpg) !important; background-attachment: fixed; background-position: bottom; background-repeat: no-repeat; background-size: cover; border-bottom: 10px solid #228ce3;">
            <div class="px-4 py-5 text-center pt-0 d-flex align-items-center justify-content-center" id="pantalla" style="height: 100%; background: #0000006b;">
                ...
                <h1 class="text-center text-white">Lista de hoteles</h1>
            </div>
        ...
        <div id="cont-principal"> 
            ...
            <div id="hoteles" class="p-5">
                <div class="row">
                    <h1 class="my-5 text-center fw-bold">¡Los mejores hoteles de <?php echo $hoteles['description'][0]; ?>!</h1>
                    <?php for($i=0;$i<$choteles;$i++){ 
                        ...
                        $ubicacion = "https://www.google.com/maps/embed/v1/search?key=AIzaSyCS7kK67VZxjgmzINsI1_C4zamwkNaUaD4&q= " . str_replace("&", "and", $hoteles['name'][$i] . "+" .$hoteles['city'][$i]) . "&center={$hoteles['latitude'][$i]},{$hoteles['longitude'][$i]}&zoom=18";
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="tar-hotel">
                            ...
                            <div class="cont-tit-hot p-1"><h2 class="mt-3 fw-bold"><?php echo substr($hoteles['name'][$i],0,24)."."; ?></h2></div>
                            <div class="row p-3">
                                <div class="col-md-7 ">
                                ...
                                <div class="col-md-5 text-center">
                                    <a href='./../detalleshotel?code=<?php echo $hoteles['idhotel'][$i]; ?>' class="btn w-100 rounded-0 text-white fw-bold" style="background: #e3223e;">Ver más</a>
                                </div>
                            </div>
                        </div>
                ...
                <nav>
                    ...
                    <ul class="pagination">
                        ...
                        <?php if ($pagina > 1) { ?>
                            <li class="paginacion">
                                <a href="./../lista-hoteles?pagina=<?php echo 1 ?>&countrycode=<?php echo $CountryCode; ?>">
                        ...
                        <?php if ($pagina > 1) { ?>
                            <li class="paginacion">
                                <a href="./../lista-hoteles?pagina=<?php echo $pagina - 1 ?>&countrycode=<?php echo $CountryCode; ?>">
                        ...
                        <?php for ($x = $inicio; $x <= $fin; $x++) { ?>
                            <li class="<?php if ($x == $pagina) echo "active" ?> paginacion">
                                <a class="pag-act fw-bold" href="./../lista-hoteles?pagina=<?php echo $x ?>&countrycode=<?php echo $CountryCode; ?>">
                                    <?php echo $x ?></a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($pagina < $paginas) { ?>
                            <li class="paginacion">
                                <a href="./../lista-hoteles?pagina=<?php echo $inicio + 1 ?>&countrycode=<?php echo $CountryCode; ?>">
                        ...
                        <?php if ($pagina < $paginas) { ?>
                            <li class="paginacion">
                                <a href="./../lista-hoteles?pagina=<?php echo $paginas ?>&countrycode=<?php echo $CountryCode; ?>">
